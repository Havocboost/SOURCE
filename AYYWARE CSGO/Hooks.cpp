...
void ClanTag()
{
	...
	case 1:
	{
		...
		case 11:SetClanTag("pasteware  ", "pasteware"); break;
		case 12:SetClanTag("asteware   ", "pasteware"); break;
		case 13:SetClanTag("steware    ", "pasteware"); break;
		case 14:SetClanTag("teware     ", "pasteware"); break;
		case 15:SetClanTag("eware      ", "pasteware"); break;
		case 16:SetClanTag("ware       ", "pasteware"); break;
		case 17:SetClanTag("are        ", "pasteware"); break;
		case 18:SetClanTag("re         ", "pasteware"); break;
		case 19:SetClanTag("e          ", "pasteware"); break;
		}
		counter++;
	}
	break;
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "arduino.cc"); break;
		case 1:SetClanTag("         a", "arduino.cc"); break;
		case 2:SetClanTag("        ar", "arduino.cc"); break;
		case 3:SetClanTag("       ard", "arduino.cc"); break;
		case 4:SetClanTag("      ardu", "arduino.cc"); break;
		case 5:SetClanTag("     ardui", "arduino.cc"); break;
		case 6:SetClanTag("    arduino", "arduino.cc"); break;
		case 7:SetClanTag("   arduino.", "arduino.cc"); break;
		case 8:SetClanTag(" arduino.", "arduino.cc"); break;
		case 9:SetClanTag("arduino.c", "arduino.cc"); break;
		case 10:SetClanTag("arduino.cc", "arduino.cc"); break;
		case 11:SetClanTag("rduino.cc ", "arduino.cc"); break;
		case 12:SetClanTag("duino.cc  ", "arduino.cc"); break;
		case 13:SetClanTag("uino.cc   ", "arduino.cc"); break;
		case 14:SetClanTag("ino.cc ", "arduino.cc"); break;
		case 15:SetClanTag("no.cc     ", "arduino.cc"); break;
		case 16:SetClanTag("o.cc      ", "arduino.cc"); break;
		case 17:SetClanTag(" .cc      ", "arduino.cc"); break;
		case 18:SetClanTag("cc        ", "arduino.cc"); break;
		case 19:SetClanTag("c         ", "arduino.cc"); break;
		case 20:SetClanTag("          ", "arduino.cc"); break;
		}
		counter++;
	}
	break;
	case 3:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "envorial.win"); break;
		case 1:SetClanTag("         e", "envorial.win"); break;
		case 2:SetClanTag("        en", "envorial.win"); break;
		case 3:SetClanTag("       env", "envorial.win"); break;
		case 4:SetClanTag("      envo", "envorial.win"); break;
		case 5:SetClanTag("     envor", "envorial.win"); break;
		case 6:SetClanTag("    envori", "envorial.win"); break;
		case 7:SetClanTag("   envoria", "envorial.win"); break;
		case 8:SetClanTag(" envorial", "envorial.win"); break;
		case 9:SetClanTag("envorial.", "envorial.win"); break;
		case 10:SetClanTag("envorial.w", "envorial.win"); break;
		case 11:SetClanTag("envorial.wi", "envorial.win"); break;
		case 12:SetClanTag("envorial.win ", "envorial.win"); break;
		case 13:SetClanTag("nvorial.win  ", "envorial.win"); break;
		case 14:SetClanTag("vorial.win  ", "envorial.win"); break;
		case 15:SetClanTag("orial.win   ", "envorial.win"); break;
		case 16:SetClanTag("rial.win    ", "envorial.win"); break;
		case 17:SetClanTag("ial.win     ", "envorial.win"); break;
		case 18:SetClanTag("al.win      ", "envorial.win"); break;
		case 19:SetClanTag("l.win       ", "envorial.win"); break;
		case 20:SetClanTag(".win        ", "envorial.win"); break;
		case 21:SetClanTag("win         ", "envorial.win"); break;
		case 22:SetClanTag("in          ", "envorial.win"); break;
		case 23:SetClanTag("n           ", "envorial.win"); break;
		case 24:SetClanTag("            ", "envorial.win"); break;
		}
		counter++;
	}
	break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{	
		...
		Render::Text(10, 10, Color(255, 255, 255, 255), Render::Fonts::Menu, "WarmHook - Build 2.1");
