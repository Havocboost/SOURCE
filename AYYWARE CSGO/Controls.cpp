...
void CCheckBox::Draw(bool hover)
{
	...
	Render::Outline(a.x, a.y, 13, 13, Color(104, 104, 104, 255));

	if (hover)
	{
		if (Checked)
		{
			Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(130, 245, 0, 255));
		}
		else
		{
	...
	{
		Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(140, 255, 0, 255));
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(20, 20, 20, 80));
	}
}
...
void CSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x + Location, a.y + 1, 4, 9, Color(140, 255, 0, 255));
